...
Original file is located at
    https://colab.research.google.com/drive/1yUk1bRBmvODaJU5h8ksgk6BVzfICzmzG
"""
...
#Function in charge of creating random exponential variables based on the lambda passed in
def generate_random_exp_variable(lambda_val):
  import math, random
...
def mm1_simulation(T, L, C, r):
  ...
  print("For MM1 simulation with utilization = ", r,":")
  print("E_n: ", e_n)
  print("P_idle: ", p_idle)
...
def mm1k_simulation(T, L, C, r, K):
  ...
  print("For MM1K simulation with K = ", K, " and utilization = ", r,":")
  print("E_n: ", e_n)
  print("P_idle: ", p_idle)
  print("P_loss: ", p_loss, "\n")
...
def plot_mm1k_simulations(T, L, C, rho_values, K):
  ...
  for i in range(len(K)):
    en_ax.plot(rho_values, en_list[i], label=K[i])
    idle_ax.plot(rho_values, p_idle_list[i], label=K[i])
    loss_ax.plot(rho_values, p_loss_list[i], label=K[i])
